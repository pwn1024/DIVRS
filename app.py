...
flags.DEFINE_string('name', 'ml10m-DIVRS-debug', 'Experiment name.')
flags.DEFINE_enum('model', 'DIVRS', ['MF', 'DIVRS', 'IPS', 'CausE', 'LGN', DIVRS_GCN', 'LGNIPS', 'LGNCausE'], 'Model name.')
...
flags.DEFINE_enum('dataset', 'ml10m', ['ml10m', 'douban'], 'Dataset.')
flags.DEFINE_integer('embedding_size', 128, 'Embedding size for embedding based models.')
...
flags.DEFINE_multi_integer('topk', [5, 10, 20, 30, 40, 50], 'Topk for testing recommendation performance.')
flags.DEFINE_integer('num_workers', 80, 'Number of processes for training and testing.')
